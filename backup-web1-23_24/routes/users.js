...
router.post('/login', (req, res, next) => {
    ...
    if (userFound) {
        if (userFound.active == false) {
            ...
            authenticateUser(req, userFound, res);
        }
    }
    else {
...
function handleAdminRedirect(userFound, req, res) {
    if (userFound.admin) {
